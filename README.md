...
[![Version](https://img.shields.io/badge/version-0.6.0-blue.svg)](https://github.com/umytbaynazarov-coder/Agent-Identity/releases/tag/v0.6.0)
...
- **📚 Interactive API Documentation** - Swagger UI at `/api-docs` with OpenAPI 3.1 spec
- **🔍 Enhanced Health Monitoring** - `/health` + `/health/detailed` endpoints with memory & database checks
- **📈 Live Status Page** - Real-time monitoring at [agentauths.betteruptime.com](https://agentauths.betteruptime.com/)
- **📖 Deployment Guides** - Railway, Render, DigitalOcean, Docker Compose
- **🎯 99.9% Uptime SLA** - Documented commitment with incident response process
- **📜 Legal & Security Docs** - SECURITY.md, CONTRIBUTING.md, TOS, Privacy Policy
- **🛡️ Operational Transparency** - Public incident log & postmortem template

[See full changelog →](agentauth/CHANGELOG.md#060---2026-02-01)
